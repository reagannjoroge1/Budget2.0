...
const DB = (() => {
  ...
  /* ── WARDS — all 85 Nairobi wards with per-FY budget multipliers ── */
  // Base budgets are FY 2024/25 (fy2025). Earlier FYs scale by the same growthBase used for depts.
  const wardsBase = [
    // Westlands Constituency
    { name:'Westlands',           sub:'Westlands',         const:'Westlands',         lat:-1.2648,lng:36.8025,budget:28_500_000,risk:'medium' },
    { name:'Parklands/Highridge', sub:'Westlands',         const:'Westlands',         lat:-1.2580,lng:36.8201,budget:26_000_000,risk:'low'    },
    { name:'Karura',              sub:'Westlands',         const:'Westlands',         lat:-1.2360,lng:36.8100,budget:22_000_000,risk:'low'    },
    { name:'Kangemi',             sub:'Westlands',         const:'Westlands',         lat:-1.2620,lng:36.7660,budget:21_000_000,risk:'medium' },
    { name:'Mountain View',       sub:'Westlands',         const:'Westlands',         lat:-1.2540,lng:36.7780,budget:20_500_000,risk:'low'    },
    // Kasarani Constituency
    { name:'Kasarani',            sub:'Kasarani',          const:'Kasarani',          lat:-1.2225,lng:36.8947,budget:31_000_000,risk:'medium' },
    { name:'Githurai',            sub:'Kasarani',          const:'Kasarani',          lat:-1.1774,lng:36.9149,budget:24_000_000,risk:'high'   },
    { name:'Kahawa West',         sub:'Kasarani',          const:'Kasarani',          lat:-1.1850,lng:36.8950,budget:21_000_000,risk:'low'    },
    { name:'Kahawa',              sub:'Kasarani',          const:'Kasarani',          lat:-1.1720,lng:36.9250,budget:20_500_000,risk:'low'    },
    { name:'Seasons',             sub:'Kasarani',          const:'Kasarani',          lat:-1.2050,lng:36.9100,budget:19_500_000,risk:'medium' },
    // Roysambu Constituency
    { name:'Roysambu',            sub:'Roysambu',          const:'Roysambu',          lat:-1.2122,lng:36.8780,budget:22_500_000,risk:'medium' },
    { name:'Lucky Summer',        sub:'Roysambu',          const:'Roysambu',          lat:-1.2350,lng:36.8850,budget:20_000_000,risk:'medium' },
    { name:'Zimmerman',           sub:'Roysambu',          const:'Roysambu',          lat:-1.2000,lng:36.8900,budget:20_000_000,risk:'medium' },
    { name:'Githurai 44',         sub:'Roysambu',          const:'Roysambu',          lat:-1.1920,lng:36.9020,budget:19_500_000,risk:'high'   },
    { name:'Kamiti Corner',       sub:'Roysambu',          const:'Roysambu',          lat:-1.1900,lng:36.8750,budget:18_000_000,risk:'low'    },
    // Ruaraka Constituency
    { name:'Ruaraka',             sub:'Ruaraka',           const:'Ruaraka',           lat:-1.2300,lng:36.8880,budget:23_000_000,risk:'medium' },
    { name:'Utalii',              sub:'Ruaraka',           const:'Ruaraka',           lat:-1.2188,lng:36.9000,budget:19_500_000,risk:'low'    },
    { name:'Korogocho',           sub:'Ruaraka',           const:'Ruaraka',           lat:-1.2467,lng:36.8878,budget:17_000_000,risk:'high'   },
    { name:'Baba Dogo',           sub:'Ruaraka',           const:'Ruaraka',           lat:-1.2520,lng:36.8810,budget:18_000_000,risk:'high'   },
    { name:'Mathare North',       sub:'Mathare',           const:'Ruaraka',           lat:-1.2600,lng:36.8550,budget:16_500_000,risk:'high'   },
    // Starehe Constituency
    { name:'Nairobi Central',     sub:'Starehe',           const:'Starehe',           lat:-1.2864,lng:36.8172,budget:35_000_000,risk:'high'   },
    { name:'Harambee',            sub:'Starehe',           const:'Starehe',           lat:-1.2864,lng:36.8220,budget:22_000_000,risk:'low'    },
    { name:'Ngara',               sub:'Starehe',           const:'Starehe',           lat:-1.2760,lng:36.8260,budget:19_000_000,risk:'medium' },
    { name:'Pangani',             sub:'Starehe',           const:'Starehe',           lat:-1.2720,lng:36.8380,budget:18_500_000,risk:'medium' },
    { name:'Ziwani/Kariokor',     sub:'Starehe',           const:'Starehe',           lat:-1.2800,lng:36.8300,budget:17_500_000,risk:'medium' },
    { name:'Landimawe',           sub:'Starehe',           const:'Starehe',           lat:-1.2780,lng:36.8200,budget:17_000_000,risk:'low'    },
    // Dagoretti North Constituency
    { name:'Kilimani',            sub:'Dagoretti North',   const:'Dagoretti North',   lat:-1.2890,lng:36.7820,budget:30_000_000,risk:'low'    },
    { name:'Kawangware',          sub:'Dagoretti North',   const:'Dagoretti North',   lat:-1.2680,lng:36.7580,budget:21_500_000,risk:'high'   },
    { name:'Gatina',              sub:'Dagoretti North',   const:'Dagoretti North',   lat:-1.2760,lng:36.7500,budget:19_000_000,risk:'medium' },
    { name:'Kileleshwa',          sub:'Dagoretti North',   const:'Dagoretti North',   lat:-1.2830,lng:36.7700,budget:25_000_000,risk:'low'    },
    { name:'Kabiro',              sub:'Dagoretti North',   const:'Dagoretti North',   lat:-1.2700,lng:36.7600,budget:18_500_000,risk:'medium' },
    // Dagoretti South Constituency
    { name:'Mutuini',             sub:'Dagoretti South',   const:'Dagoretti South',   lat:-1.3100,lng:36.7450,budget:18_000_000,risk:'low'    },
    { name:'Ngando',              sub:'Dagoretti South',   const:'Dagoretti South',   lat:-1.3050,lng:36.7600,budget:17_500_000,risk:'medium' },
    { name:'Riruta',              sub:'Dagoretti South',   const:'Dagoretti South',   lat:-1.3000,lng:36.7500,budget:19_000_000,risk:'medium' },
    { name:'Uthiru/Ruthimitu',    sub:'Dagoretti South',   const:'Dagoretti South',   lat:-1.2920,lng:36.7350,budget:18_500_000,risk:'low'    },
    { name:'Waithaka',            sub:'Dagoretti South',   const:'Dagoretti South',   lat:-1.3200,lng:36.7400,budget:17_000_000,risk:'low'    },
    // Langata Constituency
    { name:'Langata',             sub:'Langata',           const:'Langata',           lat:-1.3450,lng:36.7560,budget:23_500_000,risk:'low'    },
    { name:'Karen',               sub:'Langata',           const:'Langata',           lat:-1.3430,lng:36.7200,budget:27_000_000,risk:'low'    },
    { name:'Woodley/Kenyatta',    sub:'Langata',           const:'Langata',           lat:-1.3100,lng:36.7850,budget:24_000_000,risk:'low'    },
    { name:'South C',             sub:'Langata',           const:'Langata',           lat:-1.3150,lng:36.8050,budget:22_000_000,risk:'low'    },
    { name:'Nairobi West',        sub:'Langata',           const:'Langata',           lat:-1.3200,lng:36.8100,budget:21_000_000,risk:'medium' },
    // Kibra Constituency
    { name:'Kibra',               sub:'Kibra',             const:'Kibra',             lat:-1.3100,lng:36.7830,budget:29_000_000,risk:'high'   },
    { name:'Woodley',             sub:'Kibra',             const:'Kibra',             lat:-1.3020,lng:36.7900,budget:20_000_000,risk:'medium' },
    { name:'Sarang\'ombe',        sub:'Kibra',             const:'Kibra',             lat:-1.3050,lng:36.7750,budget:18_500_000,risk:'high'   },
    { name:'Laini Saba',          sub:'Kibra',             const:'Kibra',             lat:-1.3080,lng:36.7700,budget:17_500_000,risk:'high'   },
    { name:'Makina',              sub:'Kibra',             const:'Kibra',             lat:-1.3120,lng:36.7780,budget:17_000_000,risk:'high'   },
    // Kamukunji Constituency
    { name:'Kamukunji',           sub:'Kamukunji',         const:'Kamukunji',         lat:-1.2780,lng:36.8430,budget:20_000_000,risk:'high'   },
    { name:'Eastleigh North',     sub:'Kamukunji',         const:'Kamukunji',         lat:-1.2720,lng:36.8520,budget:19_000_000,risk:'medium' },
    { name:'Eastleigh South',     sub:'Kamukunji',         const:'Kamukunji',         lat:-1.2780,lng:36.8600,budget:19_500_000,risk:'medium' },
    { name:'Airbase',             sub:'Kamukunji',         const:'Kamukunji',         lat:-1.2840,lng:36.8480,budget:18_000_000,risk:'medium' },
    { name:'California',          sub:'Kamukunji',         const:'Kamukunji',         lat:-1.2760,lng:36.8560,budget:17_500_000,risk:'medium' },
    // Makadara Constituency
    { name:'Makongeni',           sub:'Makadara',          const:'Makadara',          lat:-1.2978,lng:36.8620,budget:18_000_000,risk:'high'   },
    { name:'Maringo/Hamza',       sub:'Makadara',          const:'Makadara',          lat:-1.2880,lng:36.8700,budget:17_500_000,risk:'medium' },
    { name:'Viwandani',           sub:'Makadara',          const:'Makadara',          lat:-1.2950,lng:36.8750,budget:18_500_000,risk:'high'   },
    { name:'Harambee (Makadara)', sub:'Makadara',          const:'Makadara',          lat:-1.3000,lng:36.8680,budget:17_000_000,risk:'medium' },
    // Embakasi North Constituency
    { name:'Kariobangi North',    sub:'Embakasi North',    const:'Embakasi North',    lat:-1.2600,lng:36.8800,budget:21_000_000,risk:'high'   },
    { name:'Dandora Area I',      sub:'Embakasi North',    const:'Embakasi North',    lat:-1.2511,lng:36.8952,budget:19_000_000,risk:'high'   },
    { name:'Dandora Area II',     sub:'Embakasi North',    const:'Embakasi North',    lat:-1.2480,lng:36.9000,budget:18_500_000,risk:'high'   },
    { name:'Dandora Area III',    sub:'Embakasi North',    const:'Embakasi North',    lat:-1.2450,lng:36.9050,budget:18_000_000,risk:'medium' },
    { name:'Dandora Area IV',     sub:'Embakasi North',    const:'Embakasi North',    lat:-1.2420,lng:36.9080,budget:17_500_000,risk:'medium' },
    // Embakasi West Constituency
    { name:'Umoja 1',             sub:'Embakasi West',     const:'Embakasi West',     lat:-1.2750,lng:36.8850,budget:22_000_000,risk:'medium' },
    { name:'Umoja 2',             sub:'Embakasi West',     const:'Embakasi West',     lat:-1.2800,lng:36.8900,budget:21_500_000,risk:'medium' },
    { name:'Mowlem',              sub:'Embakasi West',     const:'Embakasi West',     lat:-1.2680,lng:36.8980,budget:19_000_000,risk:'medium' },
    { name:'Kariobangi South',    sub:'Embakasi West',     const:'Embakasi West',     lat:-1.2640,lng:36.8860,budget:20_000_000,risk:'high'   },
    // Embakasi Central Constituency
    { name:'Embakasi Central',    sub:'Embakasi Central',  const:'Embakasi Central',  lat:-1.3050,lng:36.9000,budget:26_000_000,risk:'medium' },
    { name:'Kayole Central',      sub:'Embakasi Central',  const:'Embakasi Central',  lat:-1.2880,lng:36.9100,budget:23_000_000,risk:'high'   },
    { name:'Kayole North',        sub:'Embakasi Central',  const:'Embakasi Central',  lat:-1.2820,lng:36.9150,budget:21_000_000,risk:'high'   },
    { name:'Kayole South',        sub:'Embakasi Central',  const:'Embakasi Central',  lat:-1.2900,lng:36.9200,budget:20_500_000,risk:'medium' },
    { name:'Matopeni/Spring Valley',sub:'Embakasi Central',const:'Embakasi Central',  lat:-1.2960,lng:36.9080,budget:19_500_000,risk:'medium' },
    // Embakasi East Constituency
    { name:'Upper Savanna',       sub:'Embakasi East',     const:'Embakasi East',     lat:-1.3200,lng:36.9100,budget:19_000_000,risk:'medium' },
    { name:'Lower Savanna',       sub:'Embakasi East',     const:'Embakasi East',     lat:-1.3300,lng:36.9200,budget:18_500_000,risk:'medium' },
    { name:'Mihang\'o',           sub:'Embakasi East',     const:'Embakasi East',     lat:-1.3100,lng:36.9300,budget:20_000_000,risk:'medium' },
    { name:'Utawala',             sub:'Embakasi East',     const:'Embakasi East',     lat:-1.3150,lng:36.9350,budget:21_000_000,risk:'low'    },
    { name:'Njiru',               sub:'Embakasi East',     const:'Embakasi East',     lat:-1.2900,lng:36.9400,budget:20_500_000,risk:'low'    },
    // Embakasi South Constituency
    { name:'Imara Daima',         sub:'Embakasi South',    const:'Embakasi South',    lat:-1.3300,lng:36.8900,budget:21_000_000,risk:'medium' },
    { name:'Kwa Njenga',          sub:'Embakasi South',    const:'Embakasi South',    lat:-1.3350,lng:36.8970,budget:19_500_000,risk:'high'   },
    { name:'Kwa Reuben',          sub:'Embakasi South',    const:'Embakasi South',    lat:-1.3280,lng:36.9000,budget:18_500_000,risk:'high'   },
    { name:'Pipeline',            sub:'Embakasi South',    const:'Embakasi South',    lat:-1.3200,lng:36.8950,budget:20_000_000,risk:'medium' },
    { name:'Kwa Kivuli',          sub:'Embakasi South',    const:'Embakasi South',    lat:-1.3380,lng:36.9030,budget:18_000_000,risk:'high'   },
    // Mathare Constituency
    { name:'Hospital',            sub:'Mathare',           const:'Mathare',           lat:-1.2650,lng:36.8500,budget:17_000_000,risk:'high'   },
    { name:'Mabatini',            sub:'Mathare',           const:'Mathare',           lat:-1.2580,lng:36.8470,budget:16_500_000,risk:'high'   },
    { name:'Huruma',              sub:'Mathare',           const:'Mathare',           lat:-1.2620,lng:36.8560,budget:17_500_000,risk:'high'   },
    { name:'Ngei',                sub:'Mathare',           const:'Mathare',           lat:-1.2640,lng:36.8620,budget:16_000_000,risk:'high'   },
    { name:'Mlango Kubwa',        sub:'Mathare',           const:'Mathare',           lat:-1.2660,lng:36.8650,budget:16_800_000,risk:'high'   },
    { name:'Kiamaiko',            sub:'Mathare',           const:'Mathare',           lat:-1.2700,lng:36.8600,budget:16_200_000,risk:'high'   },
    // Starehe additional wards
    { name:'Nairobi South',       sub:'Starehe',           const:'Starehe',           lat:-1.2950,lng:36.8150,budget:18_000_000,risk:'medium' },
    { name:'Imara',               sub:'Starehe',           const:'Starehe',           lat:-1.2920,lng:36.8100,budget:17_200_000,risk:'medium' },
  ];

  // Build per-FY ward budgets using seeded RNG — genuinely different figures per ward per FY
  const allWards = {};
  historicalFY.forEach(h => {
    const r = seededRand(h.seed * 31 + 7);   // unique seed per FY
    allWards[h.key] = wardsBase.map(w => {
      // Each ward gets its own independent jitter for this FY: ±18% around the growth trend
      const jitter = 0.82 + r() * 0.36;
      return {
        ...w,
        budget: Math.round(w.budget * h.growthBase * jitter),
      };
    });
  });
  ...
  const reportMeta = [
    ...
    { id:'ward-budgets',     title:'Ward Budget Allocation Report',       desc:'85-ward budget data with constituency, geo-coordinates and risk ratings (all FYs).', rows:85, type:'Ward', formats:['CSV','PDF'] },
  ];
  ...
  function generateCSV(id) {
    ...
    if(id==='ward-budgets'){
      const rows=[['Ward','Constituency','Sub-County','Lat','Lng','Budget KES (FY 2024/25)','Risk Level']];
      (allWards['fy2025']||[]).forEach(w=>rows.push([w.name,w.const,w.sub,w.lat,w.lng,w.budget,w.risk.toUpperCase()]));
      return rows;
    }
  ...
  /* Constituency rollup helper */
  function getConstituencyTotals(fyKey) {
    const ws = allWards[fyKey] || allWards['fy2025'];
    const map = {};
    ws.forEach(w => {
      if (!map[w.const]) map[w.const] = { name: w.const, total: 0, wards: 0, highRisk: 0 };
      map[w.const].total += w.budget;
      map[w.const].wards++;
      if (w.risk === 'high') map[w.const].highRisk++;
    });
  ...
  return {
    ...
    getCases:()=>cases,
    getWards:(fy='fy2025')=>allWards[fy]||allWards['fy2025'],
    getConstituencyTotals,
...
const Backend = (() => {
  ...
  function showTab(name){
    ...
    if(name==='ward-comparison') renderWardComparison();
    if(name==='queries') renderQueryTracker();
  }
  ...
  function renderDashboardStats(fyKey){
    ...
    const util   = pct(spent,total);

    // Previous FY for YoY comparison
    const fyList   = DB.getHistoricalFY();
    const idx      = fyList.findIndex(h=>h.key===fyKey);
    const prevFY   = idx>0 ? fyList[idx-1].key : null;
    const prevDpts = prevFY ? DB.getDepartments(prevFY) : null;
    const prevRev  = prevFY ? DB.getRevenue(prevFY) : null;
    const prevTot  = prevDpts ? prevDpts.reduce((s,d)=>s+d.total,0) : null;
    const prevSpnt = prevDpts ? prevDpts.reduce((s,d)=>s+d.spent,0) : null;

    function yoyBadge(cur, prev, isCount){
      if(prev===null||prev===undefined) return '';
      const diff=cur-prev;
      const pctChg=((diff/prev)*100).toFixed(1);
      const up=diff>=0;
      const col=up?'var(--green-light)':'var(--red)';
      const arrow=up?'&#9650;':'&#9660;';
      const label=isCount
        ? arrow+' '+Math.abs(diff)+' dept'+(Math.abs(diff)!==1?'s':'')+' vs prev yr'
        : arrow+' '+Math.abs(parseFloat(pctChg))+'% vs prev yr';
      return '<div class="stat-yoy" style="color:'+col+'">'+label+'</div>';
    }
    ...
    set('dashFYLabel', fyList[idx] ? 'FY '+fyList[idx].fy : 'FY 2024/25');

    // Inject YoY deltas
    function inject(id,html){ const el=document.getElementById('yoy-'+id); if(el) el.innerHTML=html; }
    inject('total', yoyBadge(total, prevTot));
    inject('spent', yoyBadge(spent, prevSpnt));
    inject('rev',   yoyBadge(rev.grandTotal, prevRev?prevRev.grandTotal:null));
    inject('over',  yoyBadge(over, prevDpts?prevDpts.filter(d=>d.utilisation>95).length:null, true));
    inject('util', prevDpts?(()=>{
      const prevUtil=pct(prevSpnt,prevTot);
      const diff=(util-prevUtil).toFixed(1);
      const up=parseFloat(diff)>=0;
      return '<div class="stat-yoy" style="color:'+(up?'var(--green-light)':'var(--red)')+'">'+
        (up?'&#9650;':'&#9660;')+' '+Math.abs(diff)+'pp vs prev yr</div>';
    })():'');

    renderAutoAnomalies(depts, fyKey);
  }

  /* Objective 3 — Automatic expenditure anomaly flagging */
  const ANOMALY_THRESHOLD = 0.20; // flag if utilisation deviates >20% from avg
  function renderAutoAnomalies(depts, fyKey){
    const panel=$('anomalyPanel'); if(!panel) return;
    const avgUtil = Math.round(depts.reduce((s,d)=>s+d.utilisation,0)/depts.length);
    const anomalies = depts.filter(d=>Math.abs(d.utilisation - avgUtil)/100 > ANOMALY_THRESHOLD)
      .sort((a,b)=>Math.abs(b.utilisation-avgUtil)-Math.abs(a.utilisation-avgUtil));
    set('anomaly-count', anomalies.length);
    set('anomaly-fy', fyKey.replace('fy','FY 20'));
    const list=$('anomalyList'); if(!list) return;
    if(!anomalies.length){
      list.innerHTML='<div style="color:var(--text-muted);font-size:.8rem;padding:8px 0">✅ No expenditure anomalies detected for this fiscal year.</div>';
      return;
    }
    list.innerHTML=anomalies.map(d=>{
      const dev=d.utilisation-avgUtil;
      const type=dev>0?'Over-spend':'Under-spend';
      const col=dev>0?'var(--red)':'var(--orange)';
      return `<div class="anomaly-row">
        <div class="anomaly-icon" style="color:${col}">⚠</div>
        <div class="anomaly-info">
          <div class="anomaly-dept">${d.name}</div>
          <div class="anomaly-detail">${type}: <strong style="color:${col}">${d.utilisation}%</strong> vs avg ${avgUtil}% — deviation ${dev>0?'+':''}${dev}pp · ${DB.fmt(d.total)} allocated</div>
        </div>
        <span class="anomaly-badge" style="background:${col}20;color:${col};border:1px solid ${col}40">${type}</span>
      </div>`;
    }).join('');
  }
  ...
  function renderMap(){
    ...
    DB.getWards(currentFY).forEach(w=>{
      ...
      L.circleMarker([w.lat,w.lng],{radius:r,fillColor:colors[w.risk]||'#2e9e5b',color:'rgba(255,255,255,.3)',weight:1,fillOpacity:.7})
       .bindPopup(`<div style="font-family:DM Sans,sans-serif;min-width:160px"><strong>${w.name}</strong><br><span style="color:#888;font-size:.78rem">${w.const} · ${w.sub}</span><br><span style="color:#2e9e5b;font-weight:600">${DB.fmt(w.budget)}</span><br><span style="color:${colors[w.risk]};font-size:.75rem;text-transform:uppercase">${w.risk} risk</span></div>`)
       .addTo(leafletMap);
    });
    const wl=$('wardList');
    if(wl){
      const sorted=[...DB.getWards(currentFY)].sort((a,b)=>b.budget-a.budget);
      wl.innerHTML=sorted.map(w=>`
        <div class="revenue-stat" style="cursor:pointer" onclick="Backend.flyToWard(${w.lat},${w.lng})">
          <div><div class="rev-source">${w.name}</div><div style="font-size:.72rem;color:var(--text-dim)">${w.const} · ${w.sub}</div></div>
  ...
  /* ─── WARD vs CONSTITUENCY COMPARISON (Objective 4) ─── */
  function renderWardComparison(){
    const fy = currentFY;
    const wards = DB.getWards(fy);
    const constituencies = DB.getConstituencyTotals(fy);
    const depts = DB.getDepartments(fy);

    /* -- Stats pills -- */
    set('wc-total-wards', wards.length);
    set('wc-total-const', constituencies.length);
    const totalWard = wards.reduce((s,w)=>s+w.budget,0);
    set('wc-total-alloc', DB.fmt(totalWard));
    const avgWard = Math.round(totalWard/wards.length);
    set('wc-avg-ward', DB.fmt(avgWard));

    /* -- Constituency bar chart -- */
    destroyChart('wcConstChart');
    const ctx1=$('wcConstChart'); if(!ctx1) return;
    charts['wcConstChart']=new Chart(ctx1,{
      type:'bar',
      data:{
        labels: constituencies.map(c=>c.name.length>16?c.name.slice(0,16)+'…':c.name),
        datasets:[{
          label:'Total Allocated',
          data: constituencies.map(c=>c.total),
          backgroundColor: PALETTE,
          borderColor: PALETTE.map(c=>c),
          borderWidth:1.5, borderRadius:4,
        }]
      },
      options:{...CHART_BASE, indexAxis:'y', scales:{
        x:{...CHART_BASE.scales.x, ticks:{...CHART_BASE.scales.x.ticks, callback:v=>DB.fmt(v)}},
        y:{...CHART_BASE.scales.y, ticks:{...CHART_BASE.scales.y.ticks,callback:v=>v}},
      }},
    });

    /* -- Top wards vs departments comparison chart -- */
    destroyChart('wcDeptChart');
    const ctx2=$('wcDeptChart'); if(!ctx2) return;
    const topWards=[...wards].sort((a,b)=>b.budget-a.budget).slice(0,8);
    const topDepts=depts.sort((a,b)=>b.total-a.total).slice(0,8);
    charts['wcDeptChart']=new Chart(ctx2,{
      type:'bar',
      data:{
        labels:[...topDepts.map(d=>d.name.length>18?d.name.slice(0,18)+'…':d.name),...topWards.map(w=>w.name)],
        datasets:[
          {label:'Departments',data:[...topDepts.map(d=>d.total),...topWards.map(()=>null)],backgroundColor:'rgba(46,158,91,.55)',borderColor:'#2e9e5b',borderWidth:1.5,borderRadius:4},
          {label:'Wards',data:[...topDepts.map(()=>null),...topWards.map(w=>w.budget)],backgroundColor:'rgba(240,180,41,.55)',borderColor:'#f0b429',borderWidth:1.5,borderRadius:4},
        ]
      },
      options:{...CHART_BASE, scales:{
        x:{...CHART_BASE.scales.x, ticks:{...CHART_BASE.scales.x.ticks, maxRotation:38, font:{size:10}}},
        y:{...CHART_BASE.scales.y},
      }},
    });

    /* -- Ward equity table -- */
    const tbody=document.querySelector('#wardCompTable tbody'); if(!tbody) return;
    const constFilter=$('wcConstFilter')?.value||'all';
    const filtered = constFilter==='all' ? wards : wards.filter(w=>w.const===constFilter);
    const sorted=[...filtered].sort((a,b)=>b.budget-a.budget);
    const colors={high:'var(--red)',medium:'var(--orange)',low:'var(--green-light)'};
    const max=sorted[0]?.budget||1;
    tbody.innerHTML=sorted.map((w,i)=>{
      const bar=`<div class="prog-bar-bg"><div class="prog-bar-fill" style="width:${Math.round(w.budget/max*100)}%;background:${colors[w.risk]||'var(--green-bright)'}"></div></div>`;
      const badge=w.risk==='high'?'<span class="badge badge-over">High Risk</span>':w.risk==='medium'?'<span class="badge badge-warn">Medium</span>':'<span class="badge badge-ok">Low</span>';
      const vsAvg=w.budget-avgWard;
      const vsAvgStr=`<span style="color:${vsAvg>=0?'var(--green-light)':'var(--red)'}">${vsAvg>=0?'+':''}${DB.fmt(Math.abs(vsAvg))}</span>`;
      return `<tr><td><strong>${i+1}. ${w.name}</strong></td><td>${w.const}</td><td>${w.sub}</td><td>${DB.fmt(w.budget)} ${bar}</td><td>${vsAvgStr}</td><td>${badge}</td></tr>`;
    }).join('');

    /* -- Populate constituency filter -- */
    const sel=$('wcConstFilter');
    if(sel && sel.options.length<3){
      constituencies.forEach(c=>{ const o=document.createElement('option'); o.value=c.name; o.textContent=c.name; sel.appendChild(o); });
    }
  }
  ...
  function filterWardTable(){
    ...
    const fy=currentFY;
    const wards=DB.getWards(fy);
    const avgWard=Math.round(wards.reduce((s,w)=>s+w.budget,0)/wards.length);
    const constFilter=$('wcConstFilter')?.value||'all';
    const filtered=constFilter==='all'?wards:wards.filter(w=>w.const===constFilter);
    const sorted=[...filtered].sort((a,b)=>b.budget-a.budget);
    const colors={high:'var(--red)',medium:'var(--orange)',low:'var(--green-light)'};
  ...
  /* ─── OBJECTIVE 5: CITIZEN QUERY SUBMISSION & RESPONSE TRACKING ─── */
  const queryCategories = ['Budget Allocation','Expenditure','Procurement','Ward Development','Revenue','Health','Infrastructure','Education','Water'];
  let queryStore = [
    { id:'QRY-2025-001', name:'Wanjiku Mwangi', ward:'Kibra', category:'Health', subject:'Status of Kibra dispensary drug procurement', body:'The dispensary has been without essential drugs since January 2025. Can the Health department explain the procurement status and expected delivery date for the KES 10.7B allocation?', date:'2025-03-01', status:'responded', response:'The Health department confirms drug procurement is underway. Order ref MSD/2025/KIB/04 placed Feb 28. Delivery expected April 15, 2025.', responseDate:'2025-03-08', daysToRespond:7 },
    { id:'QRY-2025-002', name:'James Otieno', ward:'Kasarani', category:'Infrastructure', subject:'Sunton road completion timeline', body:'The road at Sunton-Mugumoini has been 50% complete for over 2 years. What is the completion date and contractor penalty enforcement status?', date:'2025-03-10', status:'pending', response:null, responseDate:null, daysToRespond:null },
    { id:'QRY-2025-003', name:'Anonymous', ward:'Embakasi Central', category:'Ward Development', subject:'Ward development fund breakdown for Embakasi Central FY 2025', body:'Under the KES 2.155B ward development allocation, what specific projects are funded in Embakasi Central ward and what is their completion status?', date:'2025-02-20', status:'overdue', response:null, responseDate:null, daysToRespond:null },
    { id:'QRY-2025-004', name:'Grace Njoroge', ward:'Ruaraka', category:'Water', subject:'Borehole pump installation — Utalii ward', body:'A borehole was drilled in 2023 using county funds but the pump was never installed. The contractor has not been seen since. What action has been taken?', date:'2025-03-15', status:'responded', response:'The Mobility & Works dept confirms the pump installation contract was re-awarded in Feb 2025. Works commence April 2025. Contractor bond has been forfeited by original contractor.', responseDate:'2025-03-19', daysToRespond:4 },
  ];

  function renderQueryTracker(){
    const container=$('queryList'); if(!container) return;
    const filterEl=$('queryStatusFilter');
    const filter=filterEl?filterEl.value:'all';
    const filtered=filter==='all'?queryStore:queryStore.filter(q=>q.status===filter);

    const pending=queryStore.filter(q=>q.status==='pending').length;
    const responded=queryStore.filter(q=>q.status==='responded').length;
    const overdue=queryStore.filter(q=>q.status==='overdue').length;
    set('qstat-pending',pending); set('qstat-responded',responded); set('qstat-overdue',overdue); set('qstat-total',queryStore.length);

    container.innerHTML=filtered.map(q=>{
      const statusCfg={pending:{col:'var(--gold)',label:'⏳ Awaiting Response'},responded:{col:'var(--green-light)',label:'✅ Responded'},overdue:{col:'var(--red)',label:'🚨 Overdue (>21 days)'}};
      const sc=statusCfg[q.status]||statusCfg.pending;
      const responseHtml=q.response?`<div class="query-response"><div class="query-response-label">🏛️ County Response <span style="color:var(--text-muted);font-weight:400">(${q.responseDate} · ${q.daysToRespond} working days)</span></div><div class="query-response-body">${q.response}</div></div>`:'';
      return `<div class="query-card">
        <div class="query-card-head">
          <div><div class="query-ref">${q.id}</div><div class="query-subject">${q.subject}</div></div>
          <span class="query-status-badge" style="background:${sc.col}20;color:${sc.col};border:1px solid ${sc.col}40">${sc.label}</span>
        </div>
        <div class="query-meta">${q.name} · ${q.ward} Ward · ${q.category} · ${q.date}</div>
        <div class="query-body">${q.body}</div>
        ${responseHtml}
      </div>`;
    }).join('');
  }
  ...
  function submitQuery(){
    const nameEl=$('qryName'); const wardEl=$('qryWard'); const catEl=$('qryCategory');
    const subjEl=$('qrySubject'); const bodyEl=$('qryBody');
    const subj=subjEl?subjEl.value.trim():'';
    const body=bodyEl?bodyEl.value.trim():'';
    if(!subj||!body){ alert('Please fill in the subject and your query.'); return; }
    const name=nameEl&&nameEl.value.trim()?nameEl.value.trim():'Anonymous Resident';
    const ward=wardEl&&wardEl.value.trim()?wardEl.value.trim():'Nairobi';
    const category=catEl?catEl.value:'General';
    const id='QRY-'+Date.now().toString(36).toUpperCase().slice(-6);
    const today=new Date().toISOString().split('T')[0];
    const newQuery={id,name,ward,category,subject:subj,body,date:today,status:'pending',response:null,responseDate:null,daysToRespond:null};
    queryStore.unshift(newQuery);
    if(nameEl) nameEl.value=''; if(wardEl) wardEl.value=''; if(subjEl) subjEl.value=''; if(bodyEl) bodyEl.value='';
    const sb=$('querySuccessBox');
    if(sb){ sb.style.display='block'; sb.innerHTML=`✅ Query submitted. Reference: <strong>${id}</strong>. The county must respond within 21 working days. Track status in the list below.`; }
    renderQueryTracker();
  }
  ...
  async function submitEACC(){
    const ref = 'EACC-' + Date.now().toString(36).toUpperCase();

    /* ── Collect form fields ── */
    const getName = id => { const el=$(id); return el?el.value.trim():''; };
    const reporterName  = getName('eaccReporterName')  || 'Anonymous Citizen';
    const reporterEmail = getName('eaccReporterEmail') || (window.firebase && firebase.auth().currentUser ? firebase.auth().currentUser.email : '') || '';
    const reporterPhone = getName('eaccReporterPhone') || '(not provided)';
    const reporterWard  = getName('eaccWard')          || getName('eaccReporterWard') || 'Nairobi';
    const suspectOrg    = getName('eaccSuspectOrg')    || getName('eaccType') || getName('eaccDept') || '(not specified)';
    const incidentDesc  = getName('eaccDescription')   || getName('eaccIncident') || '(see reference)';
    const estAmount     = getName('eaccAmount')        || '(not specified)';
    const submitDate    = new Date().toLocaleDateString('en-KE',{day:'2-digit',month:'long',year:'numeric'});
    console.log('[EACC Debug] Complainant email resolved to:', reporterEmail || 'EMPTY — no email found');
    ...
    if(sb){
      ...
      sb.innerHTML=`
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
          ...
          <strong style="font-size:1rem">Submitting complaint to EACC…</strong>
        </div>
    ...
    await new Promise((resolve, reject) => {
      ...
      s.onload  = () => { emailjs.init('unXBjuXPECzlN1yMp'); resolve(); };
      s.onerror = reject;
      document.head.appendChild(s);
    });
    ...
    const baseParams = {
      ...
      reporter_email:reporterEmail || '(not provided)',
      reporter_phone:reporterPhone,
      reporter_ward: reporterWard,
      suspect_org:   suspectOrg,
      incident_desc: incidentDesc.slice(0,500),
      est_amount:    estAmount,
      submit_date:   submitDate,
    };

    try {
      /* ── Email 1: Full complaint details → EACC inbox ── */
      await emailjs.send('service_ksua9hb', 'template_hmxd19h', {
        ...baseParams,
        to_email: 'eaccmockintegritycenter@gmail.com',
        to_name:  'EACC Integrity Center',
        reply_to: reporterEmail || 'noreply@budget2.go.ke',
      });

      /* ── Email 2: Confirmation receipt → complainant ── */
      if(reporterEmail){
        await emailjs.send('service_ksua9hb', 'template_0sd7n2v', {
          ...baseParams,
          to_email:     reporterEmail,
          to_name:      reporterName,
          reply_to:     'eaccmockintegritycenter@gmail.com',
          incident_desc:`Your complaint regarding "${suspectOrg}" has been received and logged. An investigator will be assigned within 3 working days. Quote reference ${ref} in all follow-up communications. Your information will be treated with strict confidentiality.`,
          suspect_org:  'Complaint Received — Investigations Underway',
          est_amount:   `Reference No: ${ref}`,
        });
      }
      ...
      if(sb){
        sb.innerHTML=`
          <div style="display:flex;align-items:flex-start;gap:12px">
            ...
            <div>
              <div style="font-weight:700;font-size:.95rem;margin-bottom:6px">Complaint successfully submitted!</div>
              <div style="font-size:.78rem;color:var(--text-muted);line-height:1.8">
                Reference: <strong style="color:var(--green-light)">${ref}</strong><br>
                📬 Complaint details sent to <strong>EACC Integrity Center</strong><br>
                ${reporterEmail ? `📩 Confirmation email sent to <strong>${reporterEmail}</strong><br>` : ''}
                🕐 An investigator will be assigned within <strong>3 working days</strong><br><br>
                📞 Helpline: <strong>0800 720 750</strong> &nbsp;|&nbsp;
                🌐 <a href="https://eacc.go.ke" target="_blank" style="color:var(--green-light)">eacc.go.ke</a>
              </div>
            </div>
          </div>`;
      }
      ...
      console.error('[EACC EmailJS error]', err);
      if(sb){
        sb.innerHTML=`
          <div style="display:flex;align-items:flex-start;gap:12px">
            <span style="font-size:1.6rem;line-height:1">⚠️</span>
            <div>
              <div style="font-weight:700;font-size:.95rem;margin-bottom:6px">Complaint recorded — email delivery failed.</div>
              <div style="font-size:.78rem;color:var(--text-muted);line-height:1.6">
                Reference: <strong style="color:var(--green-light)">${ref}</strong><br>
                Error: ${err.text||err.message||'Unknown error'} — check browser console.<br>
                📞 Helpline: <strong>0800 720 750</strong> &nbsp;|&nbsp;
                🌐 <a href="https://eacc.go.ke" target="_blank" style="color:var(--green-light)">eacc.go.ke</a>
              </div>
            </div>
  ...
  function onFYChange(fy){
    // FIXED: 'fy'+fy gives 'fy2025' not 'fy25'
    currentFY = fy==='all' ? 'fy2025' : 'fy'+fy;
    const pill=$('fyPill');
    // Use historicalFY label (e.g. "2024/25") for correct display
    const fyList2 = DB.getHistoricalFY();
    const fyEntry = fyList2.find(h=>h.key===currentFY);
    const fyLabel = fy==='all' ? 'All Fiscal Years' : (fyEntry?'FY '+fyEntry.fy:'FY '+fy);
    if(pill) pill.textContent='📅 '+fyLabel;
    set('dashFYLabel', fyLabel);
    renderDashboardStats(currentFY);
    renderBudgetChart(currentFY);
    renderPieChart(currentFY);
    renderBudgetTable(null,currentFY);
    const wcPanel=$('tab-ward-comparison');
    if(wcPanel&&wcPanel.classList.contains('active')) renderWardComparison();
  }
  ...
  return {
    ...
    renderWardComparison, filterWardTable,
    renderQueryTracker, submitQuery,
  };
})();

/* ── BOOT ── */
const T={
  en:{t1:'Budget Dashboard',t2:'Revenue Streams',t3:'Historical Data',t4:'Corruption Detector',t5:'Ward Map',t6:'Where It Leaks',t7:'Case Tracker',t8:'Report to EACC',t9:'Key Contacts',t10:'Community Comments',t11:"People's Budget",t12:'Reports & Downloads'},
  sw:{t1:'Dashibodi ya Bajeti',t2:'Vyanzo vya Mapato',t3:'Data ya Zamani',t4:'Kigunduzi cha Ufisadi',t5:'Ramani ya Kata',t6:'Mapungufu ya Fedha',t7:'Fuatilia Kesi',t8:'Ripoti kwa EACC',t9:'Mawasiliano Muhimu',t10:'Maoni ya Wananchi',t11:'Bajeti ya Wananchi',t12:'Ripoti na Vipakuliwa'}
};
let lang='en';
const tabKeys=['budget','revenue','historical','detector','map','accountability','tracker','report','contacts','comments','peoples-budget','reports'];

function toggleLang(){
  lang = lang==='en' ? 'sw' : 'en';
  // Use getElementById directly — $ is scoped inside Backend IIFE
  const langBtn = document.getElementById('langBtn');
  if (langBtn) langBtn.textContent = lang==='en' ? 'SW' : 'EN';
  tabKeys.forEach((tab, i) => {
    const btn = document.querySelector('[data-tab="'+tab+'"]');
    const translation = T[lang]['t'+(i+1)];
    if (btn && translation) {
      const icon = btn.querySelector('.tab-icon');
      const iconHTML = icon ? icon.outerHTML : '<span class="tab-icon">📌</span>';
      btn.innerHTML = iconHTML + ' ' + translation;
    }
  });
}
